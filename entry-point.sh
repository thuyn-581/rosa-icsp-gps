...
curl -k -o app.js https://raw.githubusercontent.com/thuyn-581/rosa-icsp-gps/main/app.js || true
curl -k -o package.json https://raw.githubusercontent.com/thuyn-581/rosa-icsp-gps/main/package.json || true
