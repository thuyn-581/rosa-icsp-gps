...
async function refresh () {
  ...
  try {
    gps_query.value = JSON.parse((await execa.command('oc -n kube-system get secret additional-pull-secret -o json --insecure-skip-tls-verify=true', {shell: true})).stdout)
